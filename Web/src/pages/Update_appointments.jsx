...
const [appointments, setAppointments] = useState('');
  ...
  return (
    ...
    <Container>
      ...
      <input className='tboxName1' type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} />
      </FormGroup>

      <FormGroup className='box_group1'>
        <label htmlFor="email" className='topic1'>Email:</label>
      <input className='tboxEmail1' type="email" id="email" value={appointments.email} onChange={(e) => setEmail(e.target.value)} />
      </FormGroup>

      <FormGroup className='box_group1'>
        <label htmlFor="counselorName" className='topic1'>Counselor Name:</label>
      <input className='tboxCName1' type="text" id="name" value={appointments.counselorName} onChange={(e) => setCounselorName(e.target.value)} />
      </FormGroup>

      <FormGroup className='box_group1'>
        <label htmlFor="date" className='topic1'>Date:</label>
      <input className='tboxDate1' type="date" id="date" value={appointments.date} onChange={(e) => setDate(e.target.value)} />
      </FormGroup>

      <FormGroup className='box_group1'>
        <label htmlFor="time" className='topic1'>Time:</label>
      <input className='tboxTime1' type="time" id="time" value={appointments.time} onChange={(e) => setTime(e.target.value)} />
      </FormGroup>
